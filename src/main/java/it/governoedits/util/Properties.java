...
public final class Properties {
   ...
   *          the name of the property file resource containing for fall back
  ...
  public static String getProperty(String key, String fallbackResource)
	...
	Optional<String> tokenOpt = Optional.ofNullable(System.getProperties()
	    .getProperty(key));

	return tokenOpt.orElse(readFromResource(key, fallbackResource).orElseThrow(
	    () -> new RequiredPropertyNotFoundException(String.format(
	        NOT_FOUND_MSG, key, key, fallbackResource))));
